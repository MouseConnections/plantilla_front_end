...
@section('body')
    ...
    @section('scripts')
        <!-- nouisliderribute js -->
        <script src="{{ URL::asset('public/build/libs/nouislider/nouislider.min.js') }}"></script>
        <script src="{{ URL::asset('public/build/libs/wnumb/wNumb.min.js') }}"></script>

        <!-- range slider init -->
        <script src="{{ URL::asset('public/build/js/pages/range-sliders.init.js') }}"></script>
        <!-- App js -->
