...
@section('css')
    <!-- alertifyjs Css -->
    <link href="{{ URL::asset('public/build/libs/alertifyjs/build/css/alertify.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- alertifyjs default themes  Css -->
    <link href="{{ URL::asset('public/build/libs/alertifyjs/build/css/themes/default.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Notifications
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- alertifyjs js -->
        <script src="{{ URL::asset('public/build/libs/alertifyjs/build/alertify.min.js') }}"></script>
        <!-- notification init -->
        <script src="{{ URL::asset('public/build/js/pages/notification.init.js') }}"></script>
        <!-- App js -->
