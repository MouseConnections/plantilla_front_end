...
@section('body')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">With supporting text below as a natural lead-in to additional
                            content.</p>
                        <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light w-100">Go
                            somewhere</a>
                    </div>
                </div>
            </div><!-- end col -->
    ...
    @section('scripts')
        <!-- Card Masonry -->
        <script src="{{ URL::asset('public/build/libs/masonry-layout/masonry.pkgd.min.js') }}"></script>
        <!-- App js -->
