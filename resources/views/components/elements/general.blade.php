            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Add any of the below mentioned modifier classes to change the appearance
                            of a badge.</p>
                    </div><!-- end card header -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="spinner-border text-body m-1" role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="spinner-grow text-body m-1" role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Provide an option to dismiss or close a component with
                            ...
                            variables to replace the default <code>background-image</code>. <strong>Be sure to include text
                                for screen readers</strong>, as we’ve done with <code>aria-label</code>.</p>
                    </div><!-- end card header -->
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Disabled close buttons change their <code>opacity</code>. We’ve also
                            applied <code>pointer-events: none</code> and <code>user-select: none</code> to preventing hover
                            and active states from triggering.</p>
                    </div><!-- end card header -->
                ...
                <div class="card overflow-hidden">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Change the default <code>.btn-close</code> to be white with the
                            <code>.btn-close-white</code> class. This class uses the <code>filter</code> property to invert
                            the <code>background-image</code>.</p>
                    </div><!-- end card header -->
