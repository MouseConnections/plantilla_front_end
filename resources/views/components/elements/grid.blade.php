            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Use flexbox alignment utilities to vertically and horizontally align
                            columns</p>
                    </div><!-- end card header -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Shorthand helpers that build on top of our flexbox utilities to make
                            component layout faster and easier than ever.</p>
                    </div><!-- end card header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <h5 class="font-size-13 mb-3">Horizontal Stacks (<code>.hstack</code>) with Vertical Rule
                                (<code>.vr</code>)</h5>
                            <div class="bg-light-subtle p-3 text-center">
                                <div class="hstack gap-3">
                                    <div class="grid-example">First item</div>
