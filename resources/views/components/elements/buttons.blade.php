        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-subtle-link waves-effect">Link</button>
                            <button type="button" class="btn btn-subtle-light waves-effect">Light</button>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col -->
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-subtle-primary waves-effect waves-light"><i class="bx bx-smile font-size-16 align-middle"></i></button>
                            ...
                            <button type="button" class="btn btn-subtle-warning  waves-effect waves-light"><i class="bx bx-error font-size-16 align-middle"></i></button>
                            ...
                            <button type="button" class="btn btn-subtle-dark waves-effect waves-light"><i class="bx bx-loader font-size-16 align-middle"></i></button>
                            <button type="button" class="btn btn-subtle-light waves-effect waves-light"><i class="bx bx-hourglass font-size-16 align-middle"></i></button>
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col -->
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            <a class="btn btn-primary btn-lg disabled" role="button" aria-disabled="true">Primary
                                link</a>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Add <code>.w-xs</code>, <code>.w-sm</code>, <code>.w-md</code> and
                            <code> .w-lg</code> class for additional buttons width.</p>
                    </div><!-- end card header -->
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">Add <code>data-bs-toggle="button"</code> to toggle a button’s
                            <code>active</code> state. If you’re pre-toggling a button, you must manually add the
                            <code>.active</code> class <strong>and</strong> <code>aria-pressed="true"</code> to ensure that
                            it is conveyed appropriately to assistive technologies.</p>
                    </div><!-- end card header -->
