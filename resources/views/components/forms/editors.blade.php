...
@section('css')
    <!-- quill css -->
    <link href="{{ URL::asset('public/build/libs/quill/quill.core.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('public/build/libs/quill/quill.bubble.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('public/build/libs/quill/quill.snow.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Form Editors
@endsection
@section('body')
    ...
    @section('scripts')
        ...
        <!-- quill js -->
        <script src="{{ URL::asset('public/build/libs/quill/quill.min.js') }}"></script>
