...
@section('css')
    <!-- plugin css -->
    <link href="{{ URL::asset('public/build/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Horizontal
@endsection
@section('body')
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="card-title mb-4 text-truncate">Top Saleing Categories</h5>
                            </div>
    ...
    @section('scripts')
        ...
        <!-- Vector map-->
        <script src="{{ URL::asset('public/build/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
        <script src="{{ URL::asset('public/build/libs/jsvectormap/maps/world-merc.js') }}"></script>
