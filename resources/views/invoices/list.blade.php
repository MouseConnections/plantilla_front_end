...
@section('css')
    <!-- gridjs css -->
    <link rel="stylesheet" href="{{ URL::asset('public/build/libs/gridjs/theme/mermaid.min.css') }}">

    <!-- flatpickr css -->
    <link href="{{ URL::asset('public/build/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css">
@endsection
@section('page-title')
    Invoice List
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- gridjs js -->
        <script src="{{ URL::asset('public/build/libs/gridjs/gridjs.umd.js') }}"></script>

        <!-- flatpickr js -->
        <script src="{{ URL::asset('public/build/libs/flatpickr/flatpickr.min.js') }}"></script>
        <!-- invoice-list init -->
        <script src="{{ URL::asset('public/build/js/pages/invoice-list.init.js') }}"></script>
        <!-- App js -->
