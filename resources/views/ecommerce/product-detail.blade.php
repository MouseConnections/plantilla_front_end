...
@section('css')
    <!-- swiper css -->
    <link rel="stylesheet" href="{{ URL::asset('public/build/libs/swiper/swiper-bundle.min.css') }}">
@endsection
@section('page-title')
    Product Detail
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- swiper js -->
        <script src="{{ URL::asset('public/build/libs/swiper/swiper-bundle.min.js') }}"></script>

        <script src="{{ URL::asset('public/build/js/pages/ecommerce-product-detail.init.js') }}"></script>
        <!-- App js -->
